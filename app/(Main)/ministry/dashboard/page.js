  ...
  return (
    <div className="mb-10">
      <div className="flex mt-10 ">
        <div className="flex h-[150px] w-[350px] text-center    shadow-xl border rounded-xl mx-4 ">
          <div className="flex ">
        ...
        <div className="flex h-[150px] w-[350px] text-center    shadow-xl border rounded-xl mx-4 ">
          <div className="flex">
            ...
            <div className="stat place-items-center">
              <div className="stat-title">Number of Universities<br /> Enrolled</div>
              <div className="stat-value text-secondary">28</div>
            </div>
          </div>
        </div>
        <div className="flex h-[150px] w-[350px] text-center    shadow-xl border rounded-xl ">
          <div className=" flex">
            <div className="stat place-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14">
            ...
            <div className="stat place-items-center">
              <div className="stat-title">Number of Colleges</div>
      ...
      <div className="flex ml-12 my-14 object-center ">
        <div className="flex h-[150px] w-[500px] text-center    shadow-xl border rounded-xl mx-4 ">
          <div className="flex ">
            <div className="stat place-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14">
      ...
      <div className="flex mt-28 ">
        ...
        <div className="flex h-[150px] w-[350px] text-center    shadow-xl border rounded-xl mx-4 ">
          <div className="flex">
            ...
            <div className="stat place-items-center">
              <div className="stat-title">Mobile Application<br /> Development</div>
